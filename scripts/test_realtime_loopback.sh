...
RESOURCE_DIR="${WHISPER_CAPTIONER_RESOURCE_DIR:-/Volumes/T7_APFS/MacBackup/Movies/whisper-captioner_APP_Resource}"
MODEL="${MODEL:-$RESOURCE_DIR/whisper-models/ggml-small.bin}"
